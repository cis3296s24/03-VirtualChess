...
public class Pawn extends Piece {
    ...
    public ArrayList<Coordinates> getMoveSet() {
        ...
        if(canMoveDiagonally(targetCoordinates) && !board.getPieceAt(targetCoordinates).color.equals(this.color) && board.getPieceAt(targetCoordinates).type.equals("pawn") && board.getPieceAt(targetCoordinates).twoStepped) {
